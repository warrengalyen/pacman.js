...
var PACMAN_TRAILER_MOUTH_STATE = 3;
var PACMAN_TRAILER_MOUTH_STATE_MAX = 6;
...
function nextSequenceTrailer() {
    ...
    if (PACMAN_TRAILER_MOUTH_STATE < PACMAN_TRAILER_MOUTH_STATE_MAX) {
        PACMAN_TRAILER_MOUTH_STATE ++;
    } else {
        PACMAN_TRAILER_MOUTH_STATE = 0;
    }
...
function drawPacmanTrailer() {
    ...
    if (PACMAN_TRAILER_DIRECTION === 1) {
        startAngle = (0.35 - (PACMAN_TRAILER_MOUTH_STATE * 0.05)) * Math.PI;
        endAngle = (1.65 + (PACMAN_TRAILER_MOUTH_STATE * 0.05)) * Math.PI;
        lineToX -= 8;
    } else if (PACMAN_TRAILER_DIRECTION === 2) {
        startAngle = (0.85 - (PACMAN_TRAILER_MOUTH_STATE * 0.05)) * Math.PI;
        endAngle = (0.15 + (PACMAN_TRAILER_MOUTH_STATE * 0.05)) * Math.PI;
        lineToY -= 8;
    } else if (PACMAN_TRAILER_DIRECTION === 3) {
        startAngle = (1.35 - (PACMAN_TRAILER_MOUTH_STATE * 0.05)) * Math.PI;
        endAngle = (0.65 + (PACMAN_TRAILER_MOUTH_STATE * 0.05)) * Math.PI;
        lineToX += 8;
    } else if (PACMAN_TRAILER_DIRECTION === 4) {
        startAngle = (1.85 - (PACMAN_TRAILER_MOUTH_STATE * 0.05)) * Math.PI;
        endAngle = (1.15 + (PACMAN_TRAILER_MOUTH_STATE * 0.05)) * Math.PI;
        lineToY += 8;
    }
