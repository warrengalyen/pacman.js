...
var GHOST_BLINKY_AFRAID_TIMER = null;
var GHOST_BLINKY_AFRAID_STATE = 0;
...
var GHOST_PINKY_AFRAID_TIMER = null;
var GHOST_PINKY_AFRAID_STATE = 0;
...
var GHOST_INKY_AFRAID_TIMER = null;
var GHOST_INKY_AFRAID_STATE = 0;
...
var GHOST_CLYDE_AFRAID_TIMER = null;
var GHOST_CLYDE_AFRAID_STATE = 0;
var GHOST_CLYDE_TUNNEL = false;

var GHOST_AFRAID_COLOR = "#2d3eff";
var GHOST_AFRAID_FINISH_COLOR = "#fff";
...
function resetGhosts() {
    ...
    GHOST_BLINKY_AFRAID_TIMER = null;
    GHOST_BLINKY_AFRAID_STATE = 0;
    ...
    GHOST_PINKY_AFRAID_TIMER = null;
    GHOST_PINKY_AFRAID_STATE = 0;
    ...
    GHOST_INKY_AFRAID_TIMER = null;
    GHOST_INKY_AFRAID_STATE = 0;
...
function drawGhost(ghost) {
    ...
    if (eval('GHOST_' + ghost.toUpperCase() + '_STATE === 0')) {
        ...
        if (eval('GHOST_' + ghost.toUpperCase() + '_AFRAID_STATE === 1')) {
            eval('ctx.fillStyle = GHOST_AFRAID_FINISH_COLOR');
        } else {
            eval('ctx.fillStyle = GHOST_AFRAID_COLOR');
        }
    }
    eval('drawHelperGhost(ctx, GHOST_' + ghost.toUpperCase() + '_POSITION_X, GHOST_' + ghost.toUpperCase() + '_POSITION_Y, GHOST_' + ghost.toUpperCase() + '_DIRECTION, GHOST_' + ghost.toUpperCase() + '_BODY_STATE, GHOST_' + ghost.toUpperCase() + '_STATE, GHOST_' + ghost.toUpperCase() + '_AFRAID_STATE)');
...
function stopGhost(ghost) {
    ...
    if (eval('GHOST_' + ghost.toUpperCase() + '_STATE === 1')) {
        eval('if(GHOST_' + ghost.toUpperCase() + '_AFRAID_TIMER !== null) GHOST_' + ghost.toUpperCase() + '_AFRAID_TIMER.cancel()');
        eval('GHOST_' + ghost.toUpperCase() + '_AFRAID_TIMER = null');
        eval('GHOST_' + ghost.toUpperCase() + '_STATE = 0');
...
function pauseGhost(ghost) {
    if (eval('GHOST_' + ghost.toUpperCase() + '_STATE === 1')) {
        eval('if(GHOST_' + ghost.toUpperCase() + '_AFRAID_TIMER !== null) GHOST_' + ghost.toUpperCase() + '_AFRAID_TIMER.pause()');
    } else if (eval('GHOST_' + ghost.toUpperCase() + '_STATE === -1')) {
...
function resumeGhost(ghost) {
    if (eval('GHOST_' + ghost.toUpperCase() + '_STATE === 1')) {
        eval('if(GHOST_' + ghost.toUpperCase() + '_AFRAID_TIMER !== null) GHOST_' + ghost.toUpperCase() + '_AFRAID_TIMER.resume()');
    } else if (eval('GHOST_' + ghost.toUpperCase() + '_STATE === -1')) {
